...
READWISE_TOKEN = os.environ.get('READWISE_TOKEN', 'bBWnERIHnDcQ5ctTrleNCQIUl0T9a5wamsAgxtxDcSX7nR8Rxk')
READWISE_BASE = 'https://readwise.io/api/v2'

LASTFM_USER = 'airingursb'
LASTFM_API_KEY = os.environ.get('LASTFM_API_KEY', 'f1d1edd883ce6098652b5f10f1ff42c4')
