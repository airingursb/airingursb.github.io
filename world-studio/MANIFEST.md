...
## F · UI Icons (5 张 · 128×128 PNG · 透明背景)

> /world/ 右上角 4 个圆按钮的图标。**目前用 emoji（📷🌙🎯💭），用户说太丑、跟暖色手绘风格不搭**。
> 全部 128×128 PNG 透明背景，居中、留 ~20% padding（按钮直径 42px @3x retina = 126px 显示）。
> 风格：**STYLE.md 一致**，warm cinnamon hand-painted 软水彩感，跟 C 系列同一画师审美。
...
- [x] F 系列 (7/7) — **/world/ UI 按钮图标，替换 emoji / 文字按钮，已生成**
