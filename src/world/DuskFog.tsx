...
const PUFFS: Array<{ x: number; z: number; y: number; r: number; rot: number; spin: number; opacity: number }> = [
  { x:  8.0, z:  6.0, y: 0.30, r: 2.8, rot: 0.0, spin:  0.040, opacity: 0.28 },
  { x: 10.5, z:  5.0, y: 0.35, r: 2.4, rot: 0.7, spin: -0.030, opacity: 0.24 },
  { x: 13.5, z:  4.5, y: 0.40, r: 3.0, rot: 1.4, spin:  0.025, opacity: 0.22 },
  { x: 15.0, z:  6.0, y: 0.30, r: 2.6, rot: 2.0, spin: -0.045, opacity: 0.26 },
  { x:  6.5, z:  7.5, y: 0.32, r: 2.2, rot: 0.4, spin:  0.035, opacity: 0.20 },
  { x: 11.0, z:  8.0, y: 0.28, r: 2.5, rot: 1.1, spin: -0.038, opacity: 0.22 },
]
