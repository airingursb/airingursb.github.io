...
immersive:
  url: /en/immersive/pi-agent/
  label: Immersive
---

> This is a long-form immersive article — read the full version on the dedicated page → [Enter full version](/en/immersive/pi-agent/)

Tenth in the Field Note series. Sister pieces: [The Life of One LLM Inference](/en/immersive/llm-inference-life/) (one prompt through 28 llama.cpp stations) and [From Bytecode to Pixel](/en/immersive/chromium-renderer/) (Chromium render pipeline). This one switches the «OS» to **coding agent harness** — same method: **one through-line prompt**, real source, station by station.
...
Full read: **[The Life of a User Message Inside Pi Agent — 26-station source panorama](/en/immersive/pi-agent/)**
