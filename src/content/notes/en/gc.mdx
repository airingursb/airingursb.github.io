...
> This is an immersive long-form essay — best read in its dedicated layout → [Open the full version](/en/immersive/gc/)

The eighth piece in the **Field Note** series, siblings to «[The Life of One JS Line · QuickJS Source-Level Walkthrough](/en/immersive/quickjs/)» (one engine, full stack) and «[How V8 makes JS fast](/en/immersive/v8-fast-js/)» (multi-tier JIT). This one cuts *across* languages — how every modern runtime *handles its dead*.
