...
immersive:
  url: /en/immersive/webassembly/
  label: Immersive
---

> This is an immersive long-form essay — best read in its dedicated layout → [Open the full version](/en/immersive/webassembly/)

A companion to [«Bytecode to Pixels»](/en/immersive/chromium-renderer/) and [«How V8 Makes JS Fast»](/en/immersive/v8-fast-js/). The earlier two ask <em>how bytes become pixels</em> and <em>how JS gets fast</em>; this one asks <strong>what we use when JS still isn't fast enough</strong>. Each stands alone, but together they paint a complete portrait of the browser as a general-purpose computer.
...
Read the full piece: **[From Rust to SIMD — The Life of WebAssembly](/en/immersive/webassembly/)**
