...
immersive:
  url: /en/immersive/css-engine/
  label: Immersive
---

> This is an immersive long-form essay — best read in its dedicated layout → [Open the full version](/en/immersive/css-engine/)

A companion to [«Bytecode to Pixels»](/en/immersive/chromium-renderer/) and [«How V8 Makes JS Fast»](/en/immersive/v8-fast-js/). Those ask <em>how HTML turns into pixels</em> and <em>how JS gets fast</em>; this one tackles the most overlooked stretch in between — <strong>how a stylesheet becomes a ComputedStyle on every DOM node</strong>.
...
Read the full piece: **[The Life of a Stylesheet — Inside Chromium's CSS Engine](/en/immersive/css-engine/)**
