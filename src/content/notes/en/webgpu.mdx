...
immersive:
  url: /en/immersive/webgpu/
  label: Immersive
---

> This is an immersive long-form essay — best read in its dedicated layout → [Open the full version](/en/immersive/webgpu/)

The ninth piece in the **Field Note** series, siblings to «[The Life of One JS Line · QuickJS Source-Level Walkthrough](/en/immersive/quickjs/)» (one engine, full stack), «[How V8 makes JS fast](/en/immersive/v8-fast-js/)» (multi-tier JIT), and «[Many Ways to Die · 11 GC Families](/en/immersive/gc/)» (cross-language GC). This one cuts *vertically* through a full stack — from one JS API call down to one GPU instruction.
