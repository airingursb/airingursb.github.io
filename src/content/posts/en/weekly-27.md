...
While saying goodbye to old friends, I also got to meet some new ones. A [post I wrote that went on to reach 100,000+ reads across platforms](https://blog.ursb.me/posts/2024-summer/) brought people to me in unexpected ways. Some paid to have a conversation. A few sent emails wanting to connect. Some turned out to be people I'd worked alongside, who somehow only became real acquaintances now, at the moment of parting.
...
![](https://airing.ursb.me/image/blog/wj27/FotoJet.jpg)Those farewell days were more joyful than sad, honestly. Grateful for all of it.

![](https://airing.ursb.me/image/blog/wj27/4571730261295_.pic.jpg)**🚗 National Day Road Trip**
...
![](https://airing.ursb.me/image/blog/wj27/4641730261540_.pic.jpg)**🏡 Slow Travel and the Courtyard**
...
![](https://airing.ursb.me/image/blog/wj27/WechatIMG467.jpg)![](https://airing.ursb.me/image/blog/wj27/WechatIMG465.jpg)**💰 Insurance**
...
![](https://airing.ursb.me/image/blog/wj27/202410301213062x.png)Due to time constraints, I went through three versions of the outline before landing here (no point in blurring it — you can't read it at this size anyway). The original plan was even more comprehensive — over 200 slides.
...
- **Lightweight voice huddles**: We love Slack's Huddle feature. Many tools in China call this a "meeting" — you schedule it, the notification sounds like a ringing phone, and it all feels very formal. A Huddle is different: when you need to talk or share a screen, you start one and others join when they're ready. It's more like jumping into a voice chat in a game — lightweight and casual, which makes each conversation feel less weighty.

- **Rich integrations**: Slack's app ecosystem is well-known. We've integrated GitHub, Notion, Linear, Loom, and Xcode Cloud — combined with automations, it's essentially another kind of all-in-one.
...
![](https://airing.ursb.me/image/blog/wj27/linear-progress.png)We organize work into two-week Cycles, each with one or two themes, which helps us stay focused on what's most important right now.

![](https://airing.ursb.me/image/blog/wj27/linear-cycle.png)The milestones, task dependencies, and other foundational features are also well-crafted.
