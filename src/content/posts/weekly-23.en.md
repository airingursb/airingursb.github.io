...
![](https://airing.ursb.me/image/blog/IMG_0207.jpg)Managing time comes down to two basic things:
...
A [piece in the New York Times](https://www.nytimes.com/2023/05/28/opinion/artificial-intelligence-thinking-minds-concentration.html) from a few weeks back put it well:
...
![](https://airing.ursb.me/image/blog/20231006123136@2x.png)It's a tool for building focus. If you stay within the same app or work context for a sustained stretch, you enter a Focus state (similar to flow), and it tracks that time. But if you suddenly jump out — say, you open WeChat or browse a website unrelated to what you're doing — Rize reads that as distraction, shows a focus reminder, and ends the current focus session.

![](https://airing.ursb.me/image/blog/20231006123244@2x.png)The whole thing is remarkably simple to use — nothing to configure, AI-powered monitoring running entirely in the background, only making itself known when you're slacking or breaking focus. (Not sponsored, but if you want to try it, you can sign up at [https://rize.io?code=291287](https://rize.io?code=291287&utm_source=refer&name=Airing)…)
...
![](https://airing.ursb.me/image/blog/20231006124058@2x.png)Since then, my mood and outlook have kept improving.
...
![](https://airing.ursb.me/image/blog/IMG_0046.jpg)🌇 **Sunset**
